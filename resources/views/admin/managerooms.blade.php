                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                ...
                                <li>
                                    <a href="{{ url('/manageroom')}}">Manage room</a>
                                </li>
                    ...
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li>
                                    <a href="{{ url('/createstaff')}}">Add new client</a>
                                </li>
                                <li>
                                    <a href="{{ url('/manageclients')}}">Manage client</a>
                                </li>
    ...
    <div class="sufee-alert alert with-close alert-warning alert-dismissible fade show">
                ...
                <div class="section__content section__content--p30">
                    ...
                    <div class="container-fluid">
                            ...
                            <div class="col-md-12">
                                <!-- DATA TABLE -->
                                <h3 class="title-5 m-b-35">Rooms managements</h3>
                                <div class="table-data__tool">
                                    <div class="table-data__tool-left">
                                    <form class="form-header"   method="post">
                                    <input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>">
                                        <div class="rs-select2--light rs-select2--md">
                                            <select class="js-select2" name="roomid">
                                                <option selected="selected">Room number</option>
                                    ...
                                    <table class="table table-data2">
                                        ...
                                        @foreach ($rooms as $room)
                                            <tr class="tr-shadow">
                                                ...
                                                <td>{{ $room->roomid  }}</td>
                                                 <td class="desc">{{ $room->roomtype  }}</td>
                                                 <td>
                                                <?php
                                                    if($room->clientid =='off'){
                                                      echo  "<span class='status--denied'>Vacant</span>";
                                                    }
                                                    else
                                                    {
                                                        echo  "<span class='status--process'>Occupied</span>";
                                                    }
                                                ?>
                                                ...
                                                <td>
                                                    <div class="table-data-feature">
                                                        ...
                                                        <a href="{{ url('/viewsingleroom',$room->roomid) }}">
                                                            <i class="zmdi zmdi-eye"></i>
                                                        </button>
                                               
                                                        <button class="item" data-toggle="tooltip" data-placement="top" title="Edit Room">
                                                        <a href="{{ url('/viewupdate',$room->roomid) }}">
                                                            <i class="zmdi zmdi-edit""></i>
                                                        </button>
                                                        <button class="item" data-toggle="tooltip" data-placement="top" title="More operation">
                                                        <a href="{{ url('/more',$room->roomid,) }}">
