                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                ...
                                <li>
                                    <a href="{{ url('/vieworder')}}">View order</a>
                                </li>
                    ...
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                ...
                                <li>
                                    <a href="{{ url('/vieworder')}}">View ordes</a>
                                </li>
                                    ...
                                    <table class="table table-data2">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($clients as $client)
                                                ...
                                                <td class="desc">{{ $client->county }}</td>
                                                ...
                                                <td>
                                                    <div class="table-data-feature">
                                                        ...
                                                        <a href="{{ url('/viewsingleclient',$client->clientid) }}">
                                                            <i class="zmdi zmdi-eye"></i>
                                                        </button>
                                                        <button class="item" data-toggle="tooltip" data-placement="top" title="Edit">
                                                        <a href="{{ url('/show',$client->clientid) }}">
                                                            <i class="zmdi zmdi-edit"></i>
                                                        </button>
                                                       
                                                        <button type="submit"  class="item" data-toggle="tooltip" data-placement="top" title="Delete">
                                                        <a href="{{ url('/removeclient',$client->clientid) }}">
                                                        <i class="zmdi zmdi-delete"></i>
                                                        </button>
                                                        <button class="item" data-toggle="tooltip" data-placement="top" title="Block/Unblock">
                                                        <a href="{{ url('/status',$client->clientid) }}">
