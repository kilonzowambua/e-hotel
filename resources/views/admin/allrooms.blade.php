    ...
    <div class="sufee-alert alert with-close alert-warning alert-dismissible fade show">
                ...
                <div class="section__content section__content--p30">
                    ...
                    <div class="container-fluid">
                            ...
                            <div class="col-md-12">
                                <!-- DATA TABLE -->
                                <h3 class="title-5 m-b-35">ALL Rooms</h3>
                                            ...
                                            <tr class="tr-shadow">
                                                ...
                                                <td>
                                                    <div class="table-data-feature">
                                                        <button class="item" data-toggle="tooltip" data-placement="top" title="Rent">
                                                        <a href="/controlrent/{{$room->roomid}}/{{$clientid}}">
