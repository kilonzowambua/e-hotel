                ...
                <div class="login-logo">
                            <a href="#">
                                <img src="{{'adminasset/images/icon/logo.png' }}" alt="CoolAdmin">
                                        ...
                                        <form action="{{url('/storeclient')}}"  method = "post" >
                                        <input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>">
                                            <div class="form-group">
                                                <label for="nf-text" class=" form-control-label">Client name</label>
                                                <input type="text" id="nf-textl" name="clientname" placeholder="Enter Client name.." class="form-control">
                                               
                                            </div>
                                            <div class="form-group">
                                                <label for="nf-text" class=" form-control-label">National id</label>
                                                <input type="text" id="nf-text" name="nationalid" placeholder="Enter National id.." class="form-control">
                                                
                                            </div>
                                            <div class="form-group">
                                                <label for="nf-email" class=" form-control-label">E-mail</label>
                                                <input type="email" id="nf-email" name="email" placeholder="Enter client email.." class="form-control">
                                               
                                            </div>
                                            <div class="form-group">
                                                <label for="nf-text" class="form-control-label">Home county</label>
                                                <input type="text" id="nf-text" name="county" placeholder="Enter client county.." class="form-control">
                                                
                                            </div>
                                           
                                            <div class="form-group">
                                                <label for="nf-password" class=" form-control-label">Password</label>
                                                <input type="password" id="nf-password" name="password" placeholder="Enter client Password.." class="form-control">
