...
<div class="main-content">
            ...
            <div class="container">
                ...
                <div class="login-logo">
                        ...
                        <form action="/submitrent/<?php echo $room[0]->roomid; ?>" enctype="multipart/form-data" method = "post" >
                                        <input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>">
                                      <h3><u>Fill this blank textbox and radio to complete the rent room.</u></h3>
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" id="nf-text" readonly name="clientid" value="<?php echo $clientid; ?>" class="form-control">
                                                
                                            </div> 
                                               
                                            <div class="form-group">
                                                <label for="nf-text" class=" form-control-label">Price per day</label>
                                                <input type="text" id="nf-text" readonly name="price" placeholder="<?php echo $room[0]->price; ?>" class="form-control">
                                                
                                            </div> 

                                          <div class="form-group">
                                                <label for="nf-text" class=" form-control-label">form day:</label>
                                                <input type="date" id="nf-text"  name="dateofrent" placeholder="" class="form-control">
                                                
                                            </div>  
                                            <div class="form-group">
                                                <label for="nf-text" class=" form-control-label">To day:</label>
                                                <input type="date" id="nf-text"  name="finaldate" placeholder="" class="form-control">
                                                
                                            </div>  
                                            <div class="card-footer">
                                        <button type="submit" class="btn btn-primary btn-sm">
                                            <i class="fa fa-dot-circle-o"></i> Rent room
                                        </button>
                                        </div>
