                                ...
                                <img src="{{url('adminasset/images/icon/logo.png') }}" alt="e-hotel">
                                        ...
                                        <input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>">
                                            <div class="form-group">
                                                ...
                                                <input type="text" readonly id="nf-textl" name="clientname" placeholder="<?php echo $clients[0]->clientname;?>" class="form-control">
                                               
                                            </div>
                                            <div class="form-group">
                                                <label for="nf-text" class=" form-control-label">National id</label>
                                                <input type="text" id="nf-text" readonly name="nationalid" placeholder="<?php echo $clients[0]->nationalid; ?>" class="form-control">
                                                
                                            </div>
                                            <div class="form-group">
                                                <label for="nf-email" class=" form-control-label">E-mail</label>
                                                <input type="email" id="nf-email" readonly name="email" placeholder="<?php echo $clients[0]->email;?>" class="form-control">
                                               
                                            </div>
                                            <div class="form-group">
                                                <label for="nf-text" class=" form-control-label">Home county</label>
                                                <input type="text" id="nf-text" readonly name="county" placeholder="<?php echo $clients[0]->county; ?>" class="form-control">
