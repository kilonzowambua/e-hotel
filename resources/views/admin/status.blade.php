...
<head>
    ...
    <!-- Title Page-->
    <title>{{ 'Admin::status control'}}</title>
                ...
                <div class="login-logo">
                            <a href="#">
                                <img src="{{url('adminasset/images/icon/logo.png') }}" alt="e-hotel">
                                        ...
                                        <form action="/controlstatus/<?php echo $client[0]->clientid; ?>"  method = "post" >
                                        <input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>">
                                            <div class="form-group">
                                                <label for="nf-text" class=" form-control-label">Client name</label>
                                                <input type="text" readonly id="nf-textl" name="clientname" placeholder="<?php echo $client[0]->clientname;?>" class="form-control">
                                               
                                            </div>
                                            <?php
                                            if( $client[0]->status =='on'){
                                                      echo  "     
                                                      <div class='form-group'>
                                                     
                                                      <input type='hidden'  id='nf-textl' name='status' value='off' class='form-control'>
                                                ...
                                                <input type='hidden'  id='nf-textl' name='status' value='on' class='form-control'>
                                            ...
                                            <?php
                                                    if( $client[0]->status =='on'){
                                                      ...
                                                      <button type='submit' class='btn btn-danger btn-sm'>
                                                          <i class='fa fa-block'></i> Block client
                                                      </button>
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        <button type='submit' class='btn btn-primary btn-sm'>
                                                            <i class='fa fa-block'></i> Unblock client
                                                        </button>
