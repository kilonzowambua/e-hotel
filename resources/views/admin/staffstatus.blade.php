                ...
                <div class="login-logo">
                            <a href="#">
                                <img src="{{url('adminasset/images/icon/logo.png') }}" alt="e-hotel">
                                        ...
                                        <form action="/controlstaff/<?php echo $staff[0]->staffid; ?>"  method = "post" >
                                        <input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>">
                                          ...
                                          ?>
                                            <div class="form-group">
                                                ...
                                                <input type="email" id="nf-email"  name="email" placeholder="<?php echo $staff[0]->email;?>" class="form-control">
