...
<head>
    ...
    <!-- Title Page-->
    <title>Admin::Delete:: <?php echo $staff[0]->staffname; ?></title>
                ...
                <div class="login-logo">
                            <a href="#">
                                <img src="{{ url('adminasset/images/icon/logo.png') }}" alt="e-hotel">
                                        ...
                                        <form action="/deletestaff/<?php echo $staff[0]->staffid; ?>"  method = "POST" >
                                        <input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>">
                                            <div class="form-group">
                                                <label for="nf-text" class=" form-control-label">Staff name</label>
                                                <input type="text" id="nf-textl" name="staffname" value="<?php echo $staff[0]->staffname; ?>" class="form-control">
                                               
                                            </div>
                                            <div class="form-group">
                                                <label for="nf-text" class=" form-control-label">Work shift</label>
                                                <input type="text" id="nf-text" name="workshift" value="<?php echo $staff[0]->workshift; ?>" class="form-control">
                                                
                                            </div>
                                            <div class="form-group">
                                                <label for="nf-email" class=" form-control-label">E-mail</label>
                                                <input type="email" id="nf-email" name="email" value="<?php echo $staff[0]->email; ?>" class="form-control">
                                    ...
                                    <div class="card-footer">
                                        <button type="submit" class="btn btn-primary btn-sm">
                                            <i class="fa fa-dot-delete"></i> Delete
                                        </button>
