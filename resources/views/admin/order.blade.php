                                    ...
                                    <div class="au-card-inner">
                                        <div class="table-responsive">
                                            <table class="table table-top-countries">
                                                ...
                                                <td><?php echo $data[0]->foodname; ?></td>
                                                <td><?php echo $data[0]->quantity; ?></td>
                                                    <td><?php echo $data[0]->foodprice; ?></td>
                                                          
            <td class="text-right"> <?php echo $data[0]->totalcost; ?></td>
                                ...
                                <div>
                                                ...
                                                <a href="/pay">
                                                    ...
                                                    <span id="payment-button-amount">Pay sh.{{$rentcost}}</span>
