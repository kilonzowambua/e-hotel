    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <form action="/editsingleroom/<?php echo $room[0]->roomid; ?>" enctype="multipart/form-data" method = "post" >
            ...
            <p class='lead text-gray-800 mb-5'>Oops! Page is restricted !!</p>
            <p class='text-gray-500 mb-0'>The room is accupied </p>
            <a href='/staffdashboard'> &larr; Back to Dashboard</a>
          </div>";
                                                    }
                                                ?>
